# -*- coding: utf-8 -*-
"""Dependency_Parsing_ZSTsa_hi_25GB RAM.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1gLPhreCtBVDGlt46j1H-HIQWpzU8ot-N
...
print(all_corpus_index_test_order_s[0])

print(len(all_corpus_text_test_s))

print(len(all_corpus_index_test_order_s))
...
filepath = "drive/MyDrive/dep_zst_25gb/model.h5"
...
history=model.fit([np.array(input_set_X1),np.array(input_set_X2),np.array(input_set_X3),np.array(input_set_X4),np.array(input_set_X5),np.array(input_set_X1_target)],np.array(out_shift),batch_size=constant_batch_size,epochs=100, verbose=1,callbacks=callbacks_list,validation_split=0.2)
#!mkdir -p saved_model
...
###day 10/06/21###with 1280 sentences for with san_eng new dataset
...
###day 10/06/21###with 1280 sentences for with san_eng new dataset(5120-6400)
